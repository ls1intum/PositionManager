...
./gradlew test --tests "de.tum.cit.aet.staffplan.PositionFinderIntegrationTest"

# Run specific test category
./gradlew test --tests "de.tum.cit.aet.staffplan.PositionFinderIntegrationTest\$ValidationTests"

# Run with verbose output
./gradlew test --tests "de.tum.cit.aet.staffplan.PositionFinderIntegrationTest" --info
```
