...
public record ResearchGroupDTO(
        ...
        String professorUniversityId,
        boolean needsManualMapping,
        String mappingNotes,
        boolean archived,
        UserSummaryDTO head,
        List<String> aliases,
    ...
    public static ResearchGroupDTO fromEntity(ResearchGroup entity, int positionCount) {
        ...
        return new ResearchGroupDTO(
                ...
                entity.getProfessorEmail(),
                entity.getProfessorUniversityId(),
                entity.isNeedsManualMapping(),
                entity.getMappingNotes(),
                entity.isArchived(),
